...
export const usePhoneMask = {
  ...
  params: {
    ...
    country: 'Pre-fill the input with this country\'s dialing prefix on mount and on prop change. Accepts a |DefaultCountryId| key (e.g. |"RU"|, |"US"|); when a custom plan list is passed via |mergeDialPlans()|, new IDs are suggested automatically. The user can erase the prefix and type any number freely.',
